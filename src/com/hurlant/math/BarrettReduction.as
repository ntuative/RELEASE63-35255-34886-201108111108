package com.hurlant.math
{
    ...
    internal class BarrettReduction implements IReduction 
    {
        ...
        private var var_2543:BigInteger;

        public function BarrettReduction(param1:BigInteger)
        {
            this.r2 = new BigInteger();
            this.q3 = new BigInteger();
            BigInteger.var_1763.dlShiftTo((2 * param1.t), this.r2);
            this.var_2543 = this.r2.divide(param1);
            this.m = param1;
        }
        ...
        public function reduce(param1:BigInteger):void
        {
            ...
            this.var_2543.multiplyUpperTo(this.r2, (this.m.t + 1), this.q3);
