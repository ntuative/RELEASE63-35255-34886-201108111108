package com.sulake.habbo.help.hotelmerge
{
    ...
    public class HotelMergeNameChangeView 
    {
        ...
        private var var_2438:HotelMergeUI;
        ...
        public function showMainView():void
        {
            ...
            this.var_2438.localization.registerParameter("hotel_merge.name_change.current", "name", this.var_2438.myName);
            this._window.caption = this.var_2438.localization.getKey("hotel_merge.name_change.title.main");
        ...
        private function showSelectionView():void
        {
            if (!this.var_4019)
            {
                this.var_4019 = (this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer);
                if (!this.var_4019)
                {
                    return;
                };
            ...
            this._window.caption = this.var_2438.localization.getKey("hotel_merge.name_change.title.select");
        ...
        private function showConfirmationView():void
        {
            if (!this.var_4020)
            {
                this.var_4020 = (this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer);
                if (!this.var_4020)
                {
                    return;
                };
            ...
            this._window.caption = this.var_2438.localization.getKey("hotel_merge.name_change.title.confirm");
        ...
        private function createWindow(param1:String):IWindow
        {
            ...
            return (this.var_2438.windowManager.buildFromXML((_loc2_.content as XML)));
        }
